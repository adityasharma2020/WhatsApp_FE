...
const persistConfig = {
	key: 'user',
	storage,
	whiteList: ['user'], // whiteList: Specifies which state slices should be persisted to storage. Only the slices listed in the whiteList array will be stored locally.
